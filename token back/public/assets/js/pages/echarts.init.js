...
option = {
    ...
    legend: {
        orient: 'vertical',
        left: 'left',
        data: ['Royal','Politics','Others','Cinema','Sport'],
        textStyle: {color: '#8791af'}
    },
    ...
    series : [
        {
            ...
            center: ['50%', '60%'],
            data:[
                {value:335, name:'Royal'},
                {value:310, name:'Politics'},
                {value:234, name:'Others'},
                {value:135, name:'Cinema'},
                {value:1548, name:'Sport'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
...
var dom2 = document.getElementById("pie-chart2");
...
option2 = {
    ...
    legend: {
        orient: 'vertical',
        left: 'left',
        data: ['Actor + Actress','Politician','Others','Basketball player','Soccer player'],
        textStyle: {color: '#8791af'}
    },
    color: ['#f46a6a', '#34c38f', '#50a5f1', '#f1b44c', '#556ee6'],
    series : [
        {
            ...
            center: ['50%', '60%'],
            data:[
                {value:335, name:'Actor + Actress'},
                {value:310, name:'Politician'},
                {value:234, name:'Others'},
                {value:135, name:'Basketball player'},
                {value:1548, name:'Soccer player'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
...
var dom3 = document.getElementById("pie-chart3");
...
option3 = {
    ...
    legend: {
        orient: 'vertical',
        left: 'left',
        data: ['Limited','Rare','Legendary','Epic','Regular'],
        textStyle: {color: '#8791af'}
    },
    color: ['#f46a6a', '#34c38f', '#50a5f1', '#f1b44c', '#556ee6'],
    series : [
        {
            ...
            center: ['50%', '60%'],
            data:[
                {value:335, name:'Limited'},
                {value:310, name:'Rare'},
                {value:234, name:'Legendary'},
                {value:135, name:'Epic'},
                {value:1548, name:'Regular'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
